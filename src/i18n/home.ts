export const homeUI = {
  ...
  'zh-TW': {
    'hero.stat.history.number': '100+',
    'hero.stat.history.label': '年藝術殖民地',
    'hero.stat.species.number': '7',
    'hero.stat.species.label': '英里海岸線',
    'hero.stat.democracy.number': '20,000+',
    'hero.stat.democracy.label': '居民',
    'hero.stat.chips.number': '30+',
    'hero.stat.chips.label': '座公共海灘與海灣',
    'home.hero.subtitle': '策展島嶼的深度敘事',
    'home.hero.description': '開源、AI-friendly 的 Laguna Beach 知識庫',
    'home.hero.highlight': '從多元觀點建構，為全世界策展 Laguna Beach',
    'home.hero.cta.explore': '開始探索',
    'home.hero.transparency':
      '⚠️ 本站部分文章由 AI 輔助產生初稿，所有內容持續由社群審核改善中。發現錯誤？',
    'home.hero.transparency.link': '歡迎指正',
    'home.cover.heading': '如何理解 Laguna Beach？',
    'home.cover.lead':
      'Laguna Beach 是一座只有七英里海岸線的小城，卻承載著一整個世紀的藝術家殖民地故事。',
    'home.cover.lead2':
      '從 1900 年代初期的寫生畫家到今天的當代藝廊，每一個走進這座城的人，都用不同的眼睛看見不同的 Laguna Beach。',
    'home.cover.closing1':
      '從原住民 Acjachemen 的故土到 1927 年建市，從 1933 年起每年上演的 Pageant of the Masters 到 1993 年大火後的重建。Laguna Beach 的故事不是一條直線，而是一張網。',
    'home.cover.closing2': 'LagunaBeach.md 不是要給你答案。',
    'home.cover.closing3':
      '我們想做的，是給你一張地圖——一張讓你自己走進 Laguna Beach 的地圖。',
    'home.cover.link': '閱讀完整引言集 →',
    'home.cover.era.indigenous': 'Acjachemen 時代',
    'home.cover.era.contemporary': '當代',
    'home.cover.quote.indigenous': '「這片海岸在任何城市存在之前就有了名字。」',
    'home.cover.cite.indigenous': '— Acjachemen 部落的故土',
    'home.cover.quote.1584': '「光線不一樣。」',
    'home.cover.cite.1584': '— 1900 年代初期寫生畫家發現 Laguna Beach',
    'home.cover.quote.1697': '「藝術不是我們做的事，而是我們是什麼。」',
    'home.cover.cite.1697': '— 1918 Laguna Beach Art Association 成立',
    'home.cover.quote.1926': '「讓畫作活起來。」',
    'home.cover.cite.1926': '— 1933 Pageant of the Masters 首演',
    'home.cover.quote.1946': '「整座城一夜之間消失在火海中。」',
    'home.cover.cite.1946': '— 1993 年 Laguna Beach 大火，441 棟房屋焚毀',
