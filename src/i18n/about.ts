export const aboutUI = {
  ...
  ja: {
    ...
    'about.timeline.2026-04-08.desc.html':
      '韓国語が <strong>1記事から26記事</strong>へ成長、12のハブページを韓国読者の視点でキュレーション。日本語は <strong>35記事</strong>に拡大（コミュニティ4名が貢献）。<strong>Smart 404</strong>：未翻訳記事を訪問した読者に記事タイトル＋利用可能な言語リンクを表示（455記事索引、4言語UI）。<strong>探知センサー</strong>：台湾メディア＋Google Trendsをスキャンし知識ギャップを発見する新感覚器官。<strong>226コミット、1,428ページ、9名のアクティブ貢献者</strong>。詳細は <a href="https://github.com/wilsonkichoi/lagunabeach-md/releases/tag/v1.1.0" target="_blank">v1.1.0 Release Notes</a>。',
    ...
    'about.faq.a3.html':
      'AI は私たちの執筆ツールですが、著者ではありません。すべての記事は3段階の品質パイプラインを通過します：<strong>リサーチ</strong>（10以上の独立した出典）→ <strong>執筆</strong>（<a href="https://github.com/wilsonkichoi/lagunabeach-md/blob/main/docs/editorial/EDITORIAL.md" target="_blank">EDITORIAL.md</a> ガイドラインに準拠）→ <strong>検証</strong>（自動スキャン + 人的レビュー）。自動代謝メカニズムもあり、スクリプトが定期的に記事品質をスキャンし、最も弱い記事を優先的にリライト対象とします。進捗は <a href="/dashboard/">Dashboard</a> で確認できます。',

    'about.faq.q4': '記事に誤りがあった場合は？',
    'about.faq.a4.html':
      '素早く認め、素早く修正します。<a href="https://github.com/wilsonkichoi/lagunabeach-md/issues/new" target="_blank">GitHub Issue</a> で報告、直接 PR を提出、または Discord でお知らせください。事実誤認には24時間以内に対応することをお約束します。修正されることは恥ずかしいことではありません——それがオープンソース精神です。',
  ...
  ko: {
    ...
    'about.timeline.2026-04-08.desc.html':
      '한국어가 <strong>1편에서 26편</strong>으로 성장, 12개 허브 페이지를 한국 독자 관점에서 큐레이션. 일본어는 <strong>35편</strong>으로 확장(커뮤니티 4명 기여). <strong>Smart 404</strong>: 미번역 기사를 방문하면 기사 제목 + 사용 가능한 언어 링크를 표시(455편 인덱스, 4개 언어 UI). <strong>탐지 센서</strong>: 대만 미디어 + Google Trends를 스캔하여 지식 격차를 찾는 새로운 감각 기관. <strong>226 commits, 1,428 페이지, 9명의 활성 기여자</strong>. 자세한 내용은 <a href="https://github.com/wilsonkichoi/lagunabeach-md/releases/tag/v1.1.0" target="_blank">v1.1.0 Release Notes</a> 참조.',
    ...
    'about.faq.a3.html':
      'AI는 우리의 집필 도구이지, 저자가 아닙니다. 모든 문서는 3단계 품질 파이프라인을 거칩니다: <strong>리서치</strong>(10개 이상의 독립 출처) → <strong>집필</strong>(<a href="https://github.com/wilsonkichoi/lagunabeach-md/blob/main/docs/editorial/EDITORIAL.md" target="_blank">EDITORIAL.md</a> 편집 지침 준수) → <strong>검증</strong>(자동 스캔 + 사람 검토). 자동 대사 메커니즘도 있습니다 — 스크립트가 정기적으로 문서 품질을 스캔하고, 가장 약한 문서를 우선적으로 재작성 대기열에 넣습니다. <a href="/dashboard/">Dashboard</a>에서 실시간 진행 상황을 확인하실 수 있습니다.',

    'about.faq.q4': '문서에 오류가 있으면 어떻게 하나요?',
    'about.faq.a4.html':
      '빠르게 인정하고, 빠르게 수정합니다. <a href="https://github.com/wilsonkichoi/lagunabeach-md/issues/new" target="_blank">GitHub Issue</a>로 보고하거나, PR을 직접 제출하거나, Discord에서 알려주세요. 사실 오류에 대해 24시간 내 대응을 약속합니다. 수정받는 것은 부끄러운 일이 아닙니다 — 오픈소스 정신은 「함께 더 좋게 만드는 것」입니다.',
  ...
  'zh-TW': {
    ...
    'about.timeline.2026-04-08.desc.html':
      '韓文從 <strong>1 篇爆發到 26 篇</strong>，12 個 Hub 頁面以韓國讀者視角策展重寫。日文擴張至 <strong>35 篇</strong>（4 位社群貢獻者）。<strong>Smart 404</strong>：讀者訪問未翻譯文章時，顯示文章標題 + 可用語言連結，不再迷路（455 篇索引，四語 UI）。<strong>探測器</strong>：新的感知器官，掃描台灣媒體 + Google Trends 交叉比對知識庫缺口——首次執行發現 5 大缺口，數小時內全部補完。<strong>226 commits、1,428 頁面、9 位活躍貢獻者</strong>。完整細節見 <a href="https://github.com/wilsonkichoi/lagunabeach-md/releases/tag/v1.1.0" target="_blank">v1.1.0 Release Notes</a>。',
    ...
    'about.faq.a3.html':
      'AI 是我們的寫作工具，但不是作者。每篇文章經過三階段品質管線：<strong>研究</strong>（10+ 獨立來源）→ <strong>寫作</strong>（依照 <a href="https://github.com/wilsonkichoi/lagunabeach-md/blob/main/docs/editorial/EDITORIAL.md" target="_blank">EDITORIAL.md</a> 編輯守則）→ <strong>驗證</strong>（自動掃描 + 人工審閱）。我們也有自動代謝機制——腳本定期掃描文章品質，最差的優先排入改寫佇列。你可以在 <a href="/dashboard/">Dashboard</a> 的「免疫系統」指標即時看到進度。',

    'about.faq.q4': '如果文章有錯誤怎麼辦？',
    'about.faq.a4.html':
      '快速認錯，快速修正。你可以透過 <a href="https://github.com/wilsonkichoi/lagunabeach-md/issues/new" target="_blank">GitHub Issue</a> 回報、直接提交 PR 修正、或在我們的 Discord 社群反應。我們承諾在 24 小時內回應事實錯誤。被修正不丟臉——開源精神就是「一起讓它更好」。',
