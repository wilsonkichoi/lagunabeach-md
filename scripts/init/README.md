...
| `FRAMEWORK-VERSION` | The framework version (template `package.json` `version`) this instance adopted. Instance-owned and merge-protected; `/upgrade` bumps it after verification. |
