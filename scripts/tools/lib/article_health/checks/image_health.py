...
# 2026-06-07 directive: media completeness floor + length-scaled (REWRITE v6.8).
# Depth article media floor scales with word count. effective_min = max(min_images, round(CJK / cjk_per_media)).
# Calibration corpus: cjk_per_media=1200 -> 4500->4 / 7000->6 / 9000->8 / 10440->9.
...
# length-scaling uses prose-CJK (strip references footnote section) — footnotes can inflate CJK ~25%
# leading to excessive media requirements. Aligns with paragraph_rhythm density prose baseline.
