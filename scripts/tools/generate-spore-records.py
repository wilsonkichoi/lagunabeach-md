#!/usr/bin/env python3
"""generate-spore-records.py — SporefullRecord層 + 靜態 API Generate器（v2 JSON SSOT input）。
...
def build_records():
 ...
 if not s.get("deleted")] # 已DeleteSporeexclude於衍生Record層（spore-log SSOT 仍Keep供溯源）
