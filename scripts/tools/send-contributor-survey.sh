#!/usr/bin/env bash
# send-contributor-survey.sh — 對第一次Contribution的人發送 onboarding survey
#
# Usage:
...
#
# Why manual 而非 GitHub Actions：fork PR 的 workflow permissions fragile，
# Heartbeat Beat 3 review PR 時manualTrigger更可靠。詳見 docs/community/CONTRIBUTOR-SURVEY.md
set -uo pipefail
...
技術的障壁、ドキュメント不足、specが厳しすぎる、merge が遅すぎる⋯⋯
