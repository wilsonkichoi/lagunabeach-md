...
is disabled (explicit constraint 2026-05-12).
...
2026-05-12 session: Tier 1 OpenRouter fully rate-limited + Hy3 turned paid + Sonnet
disabled -> pivoted to OpenAI Codex subscription bypassing OpenRouter.
"""
