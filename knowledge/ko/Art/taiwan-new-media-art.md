...
중국가 자본 추진 아래 급속히 확장하는 디지털 아트 산업, 한국 정부가 대규모 투자하는 메타버스 인프라에 직면하여 타이완의 전략은 명확하다: 규모로 경쟁하지 않고, 깊이로 경쟁한다. 문제는 타이완이 할 수 있느냐가 아니라, 이 생태계가 예술가들이 더 어려운 실험을 계속할 수 있도록 지탱할 수 있느냐이다.
