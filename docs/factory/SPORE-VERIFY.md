...
| CI/CD wait gate (v3.6)    | SHIP       | 所有 spore (post 前) | `curl -sf URL \| grep title-keyword` poll 60s × 20min | 不 post + escalate | 必跑     |
...
**「必跑」15 條 / 「條件」5 條**（v3.6 新增 3 條配圖+CI/CD wait gates）。
