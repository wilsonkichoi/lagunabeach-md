...
- **AI 自主邊界**：harvest 讀取屬 AI 自主（per [DNA #26 v2](../semiont/DNA.md)），re-hook reply / 留言回覆 必 human post（AI 準備 draft 不發）
...
_對應 canonical：MANIFESTO §薄殼鐵律（routine spec ≤ 20 行薄殼，business logic 集中本 pipeline）+ DNA #26 v2（AI 自主 harvest 邊界）+ DNA #54（routine 飛輪 SSOT 收割者）+ DNA #38（SSOT drift silent killer，本檔 + ROUTINE.md + mirror 三 layer 同步）。_
