...
| ------------------------------------- | ---------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| **§觀點成型落檔**                     | Stage 0 終 | depth article                       | manual: grep `## 觀點成型` in research report + frontmatter `viewpoint_formed: true` + `### 20 路 persona 切入點` sub-section（0.6.1-bis）                                                                                                                                                                            | **不進 Stage 1**           |
