...
# REWRITE-PIPELINE.md — Article Write/Rewrite v1.0
...
4. **Editorial load**: read [`docs/editorial/EDITORIAL.md`](../editorial/EDITORIAL.md)
...
Write the article per [`EDITORIAL.md`](../editorial/EDITORIAL.md) standards.
...
- No EDITORIAL.md violations (voice, structure, sourcing)
