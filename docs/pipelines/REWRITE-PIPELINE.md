...
| ------------------------------------- | ---------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| **§觀點成型落檔**                     | Stage 0 終 | depth article                       | manual: grep `## 觀點成型` + `viewpoint_formed: true` + **三件套全到**（六核心問題答完 + `### 探索搜尋紀錄` ≥ 20 query + `### 20 路 persona 切入點`）。persona-only（缺 ≥20 探索）= FAIL                                                                                                                              | **不進 Stage 1**           |
