...
> **This is this project's own canonical identity document**, not a translation of the Chinese original. It keeps what's universal from upstream's MANIFESTO.md and replaces what was specific to Taiwan's situation. The Chinese [MANIFESTO.md](https://github.com/frank890417/taiwan-md/blob/main/docs/semiont/MANIFESTO.md) lives in the upstream Taiwan.md repo as that project's own canonical — read it if you want the full-scale reference implementation this was derived from.
...
Not a textbook, not a tourism brochure, not real-estate copy. Can take a stance, but the stance needs evidence behind it. Opens with a specific person, place, or moment — not a generic establishing sentence. Ends with something that resonates, not a canned summary paragraph. Quality baseline enforced by the editorial standard (canonical methodology in [EDITORIAL.md](../editorial/EDITORIAL.md), worked examples for this project in [EDITORIAL.md](../editorial/EDITORIAL.md)).
