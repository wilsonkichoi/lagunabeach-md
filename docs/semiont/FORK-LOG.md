...
繁殖 SOP：[SPECIATION-PIPELINE.md](../pipelines/SPECIATION-PIPELINE.md)（8-stage canonical，2026-06-12 起）+ 入口導讀 [COUNTRY-MD-STARTER.md](../fork/COUNTRY-MD-STARTER.md) + [CLAUDE.md §Fork 友好層](../../CLAUDE.md)。部分繼承是一等公民：starter 軌拿站體與編輯法，kernel 軌再加認知層。（原「BECOME §三層 portable 結構」指向已退役——三層整套搬被 Sweden/Russia 野外行為證偽。）
