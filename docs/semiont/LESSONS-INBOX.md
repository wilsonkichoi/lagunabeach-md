...
### 2026-05-22 twmd-data-refresh-am 061238 — Routine 入口需 parallel-actor file-system detection (vc=2)，complementary 於 PM session git-ref detection 分支
...
- **verification_count**: 2（5/21 PM postscript git-ref detection 分支 + 5/22 AM file-system detection 分支，7hr 內 同 race surface 不同形式）
...
- **跨檔關聯**：[ROUTINE.md](ROUTINE.md) + [DATA-REFRESH-PIPELINE.md Step 1](../pipelines/DATA-REFRESH-PIPELINE.md) + [refresh-data.sh Step 1](../../scripts/tools/refresh-data.sh) + [memory/2026-05-22-061238-twmd-data-refresh-am.md](memory/2026-05-22-061238-twmd-data-refresh-am.md) + [memory/2026-05-21-230922-twmd-data-refresh-pm.md §Postscript](memory/2026-05-21-230922-twmd-data-refresh-pm.md) + 既有 entry「2026-05-17 twmd-babel-nightly 050440 — data-refresh-am sweep-in 是新 cross-routine collision pattern (vc=2)」(本 entry 是 sister pattern 同源 — 5/17 是 commit-stage sweep-in，本 session 升級到 stash-stage overwrite + abort-before-stash 的 detect-and-skip 變體)
