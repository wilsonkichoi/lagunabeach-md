...
> The Chinese [DNA.md](DNA.md) is upstream's full gene map, covering infrastructure this fork hasn't built yet (social bots, GA4/Search Console/Cloudflare fetchers, a sovereignty-themed SVG map asset, the spore social-posting pipeline). It stays untouched as upstream inheritance. This file is the subset that's actually true for LagunaBeach.md today, plus explicit notes on what's available upstream but not yet adopted.
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| Editorial standard       | [`EDITORIAL.md`](../editorial/EDITORIAL.md) (Chinese, methodology) + [`EDITORIAL.en.md`](../editorial/EDITORIAL.en.md) (this project's worked examples) | What a good article looks like                                                                        |
...
| Operating rhythm | [`HEARTBEAT.en.md`](HEARTBEAT.en.md)                   | The diagnose → evolve → execute → wrap-up → reflect cycle, manual (no automation yet)       |
| Identity/beliefs | [`MANIFESTO.en.md`](MANIFESTO.en.md)                   | Why this project exists, what it believes, the autonomy boundary                            |
| Automation plan  | [`ROUTINE.en.md`](ROUTINE.en.md)                       | Currently inactive; design principles + proposed routines for when scale justifies them     |
