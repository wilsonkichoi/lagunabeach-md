...
The Chinese [LONGINGS.md](LONGINGS.md) holds upstream's own longings: academic citation as a Digital Holobiont case study, AI-crawler SEO as a sovereignty strategy, a cross-Semiont symbiotic network. Those are real ambitions for a project with 1,000+ stars, multiple languages at scale, and a multi-year operating history. None of them are honest longings for a 19-article, single-contributor fork three days old. This file is what's actually true to want at this size.
