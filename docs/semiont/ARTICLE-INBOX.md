...
### 三毛 NEW — 撒哈拉作家、〈橄欖樹〉詞人、80 年代華語流浪文學的指標

- **Type**: `NEW`
- **Category**: People（subcategory: 文學）
- **Priority**: `P0`
- **Status**: `pending`
- **Requested**: 2026-05-17 by 哲宇 (session 215434-manual 之後)
- **為什麼 P0**：
  - 三毛（陳平，1943-1991）是台灣戰後文學史關鍵人物，目前 Taiwan.md zero coverage（既無 standalone 也無深度 cross-ref）
  - 流浪文學 + 80 年代華語世界 cultural icon — 對台灣文藝青年 + 對外的台灣女性作家形象構成決定性影響
  - 跨類別 spawning anchor：文學（撒哈拉的故事 / 雨季不再來）/ 音樂（〈橄欖樹〉齊豫詞作）/ 流浪敘事 / 性別書寫 / 兩岸文化交流（90 年代後在中國的爆紅）
  - 媒體編織機會大：齊豫〈橄欖樹〉官方 MV + 三毛親自演講影像 + 撒哈拉場景紀錄影像 — per [EDITORIAL §媒體編織 類型 baseline](../editorial/EDITORIAL.md#媒體編織圖片與影片穿插的敘事流2026-05-17-新增)（音樂人 / 作家類 2-3+ 影片）
- **Notes**：
  - 政治敏感性：低（個人生命史為主）
  - **核心 facts to verify**（三源驗證 per REFLEXES #16）：
    - 本名陳懋平 → 後改名陳平 / 1943-03-26 生於重慶 / 1991-01-04 過世
    - 死因（榮民總醫院自縊 — 官方版本；民間有醫療事故 / 他殺說法 — 寫進文章需小心處理，採信官方但承認爭議存在）
    - 荷西 José María Quero（西班牙籍）/ 1973 結婚 / 1979-09-30 拉芭瑪斯潛水意外身亡
    - 〈橄欖樹〉作詞時間 + 收錄於齊豫 1979《橄欖樹》專輯（李泰祥曲）— 與西班牙原作品 Joan Manuel Serrat〈Mediterráneo〉的關係需釐清（坊間傳言三毛是改編自西班牙詩，需查證）
    - 著作時間軸：《撒哈拉的故事》1976（皇冠）/《雨季不再來》1976 /《稻草人手記》1977 /《哭泣的駱駝》1977 /《溫柔的夜》1979 /《夢裡花落知多少》1981 等
    - 文化大學哲學系（後輟學）+ 西班牙馬德里 / 德國 / 美國留學路徑
    - 父親陳嗣慶（律師）/ 三毛筆名來源（自稱來自《三毛流浪記》/ 張樂平）
  - **核心矛盾候選**（Stage 0 §觀點成型，≤ 30 字）：
    - A.「撒哈拉的浪漫敘事，回到台北的失語結局」
    - B.「為了一個西班牙男人遠走撒哈拉，回來成了一整代華語讀者的『遠方』代名詞」
    - C.「散文是真實的，但她也很清楚自己在寫一個夢」
  - **Title 三明治候選**：
    - 「三毛（1943-1991）：撒哈拉的浪漫主義者，台北榮總的最後夜晚」
    - 「三毛：寫〈橄欖樹〉的那個遠方，跟把自己關進浴室的那個房間」
    - 「三毛：陳平、Echo、撒哈拉、荷西、〈橄欖樹〉、榮總」
  - **媒體編織計畫**（per 類型 baseline 「音樂人 / 文學人物」）：
    - **圖片** 2-3 張（CC BY-SA 或 PD 來源）：三毛年輕時 / 撒哈拉時期 / 與荷西合影（Commons / Flickr CC search）
    - **影片** 2-3 個 official iframe 候選：
      - 齊豫〈橄欖樹〉official MV（滾石 / 滾石音樂官方頻道）
      - 三毛 1980s 演講 / 訪談影像（公視 / 中視官方頻道）
      - 三毛紀錄片片段（如有）
  - **跨類別 cross-link 候選**（雙向）：
    - `knowledge/Music/齊豫` 或 `knowledge/Music/台灣民歌運動.md`（橄欖樹 → 民歌運動 + 跨界詞作）
    - `knowledge/People/李泰祥`（如有 / 沒有則暗示 spawning candidate）— 〈橄欖樹〉作曲
    - `knowledge/Culture/台灣文學`（戒嚴後文學 / 解嚴後文學）— 三毛 vs 嚴肅文學的位置
    - `knowledge/People/張曼娟` 等 80 年代女作家系列（如有）
    - `knowledge/Geography/` 撒哈拉相關（如無對應頁，可在文章中 inline link 外部資源）
  - **必讀研究來源**：
    - 三毛中文維基百科條目 + 英文維基百科 Echo Chan
    - 皇冠出版社三毛全集出版年表
    - 中央社 / 聯合報 1991 過世時的當代訃聞 + 後續解密報導
    - 齊豫官方頻道（滾石音樂）〈橄欖樹〉MV verbatim 標題
    - 國家文化記憶庫（如有三毛條目）
    - 學術論文（搜「三毛 撒哈拉 流浪文學」）
  - **潛在陷阱**：
    - 死因爭議寫法 — 主敘事採信官方自縊，但需 footnote 承認爭議存在，避免被「Taiwan.md 抹殺真相」攻擊
    - 跟王洛賓晚年戀情寫法 — 需根據三毛自己的書信 + 王洛賓家人說法雙源，避免單方面敘事
    - 「橄欖樹」原作關係 — 需準確區分李泰祥曲 / 三毛詞 / 與西班牙原曲的關係（坊間有誤傳）
    - 中國大陸後續神化敘事 vs 台灣文學圈的相對冷處理 — 文章 framing 從台灣視角出發，可在 §後續影響段提及兩岸接受度差異
- **Reference**:
  - https://zh.wikipedia.org/wiki/三毛_(作家)
  - https://en.wikipedia.org/wiki/Sanmao_(author)
  - 皇冠文化出版集團三毛專區
  - 中央社 1991-01-04 訃聞
  - 齊豫官方頻道 / 滾石音樂 official YT
- **預估時間**：~150 min（NEW 從零起 + Stage 1 deep research 40-50 min ≥ 25 search + Stage 2 寫作 60-70 min ~5K-6K CJK chars + Stage 3-5 verify + media manifest 30 min）
- **後續孢子潛力**：高 — 〈橄欖樹〉一句詞 / 撒哈拉一個場景 / 1991 最後一夜 — 三個 hook 都適合 Threads 孢子
