...
<!-- STATS:START — auto-generated by scripts/tools/update-stats.sh from SSOT (knowledge/ + contributors.json + dashboard-vitals.json + GitHub API). Do not edit by hand. -->

| Metric                         | Count |
| ------------------------------ | ----- |
| 📄 Total articles (zh-TW SSOT) | 793   |
| 🇹🇼 Chinese (zh-TW)             | 793   |
| 🇺🇸 English (en)                | 799   |
| 🇯🇵 日本語 (ja)                 | 795   |
| 🇰🇷 한국어 (ko)                 | 796   |
